...
def format_terminal_output(data, month, transactions_count=0):
    ...
    output.append("----- EXPENSE CATEGORIES -----".center(40))
    ...
    output.append("===== DAILY SPENDING and NORMS =====".center(40))
    ...
    output.append("===== DAILY SPENDING RECOMMENDATIONS =====".center(40))
...
def terminal_visualization(data):
    ...
    print("----- EXPENSE CATEGORIES -----".center(40))
    ...
    print("===== DAILY SPENDING and NORMS =====".center(40))
    ...
    # Recommendations
    print("===== DAILY SPENDING RECOMMENDATIONS =====".center(40))
